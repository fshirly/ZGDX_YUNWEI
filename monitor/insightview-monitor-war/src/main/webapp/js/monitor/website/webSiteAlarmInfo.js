	   ...
	   .datagrid(
	     {
	      ...
	      fit : true,// 自动大小
	      fitColumns:true,
	      url : path + '/monitor/webSiteWidget/getWebSiteAlarmInfo?alarmNum='+alarmNum+'&moID='+moID+'&moClass='+moClass,
	      idField : 'fldId',
...
function reloadTableCommon_1(dataGridId,alarmNum,moID) {
	$('#' + dataGridId).datagrid({
		url : getRootName() + '/monitor/webSiteWidget/getWebSiteAlarmInfo?alarmNum='+alarmNum+'&moID='+moID,
	});
