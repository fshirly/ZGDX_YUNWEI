	   ...
	   .datagrid(
	     {
	      ...
	      fit : true,// 自动大小
	      fitColumns:true,
	      url : path + '/monitor/tomcatManage/getMiddleWareAlarmInfo?alarmNum='+alarmNum+'&moID='+moID,
	      idField : 'fldId',
...
function reloadTableCommon_1(dataGridId,alarmNum,moID) {
	$('#' + dataGridId).datagrid({
		url : getRootName() +'/monitor/tomcatManage/getMiddleWareAlarmInfo?alarmNum='+alarmNum+'&moID='+moID,
	});
