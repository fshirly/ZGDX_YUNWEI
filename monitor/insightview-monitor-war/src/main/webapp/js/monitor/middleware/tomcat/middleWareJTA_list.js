...
function doInitTable() {
	...
	var uri = path + '/monitor/DeviceTomcatManage/listMiddleWareJTA?parentMoId=' + parentMoId+'&jmxType='+jmxType;
	$('#tblDataList')
			.datagrid(
					{
						width : 'auto',
...
function sel(moid){
	if(window.opener) { 
	     fWindowText1 = window.opener.document.getElementById("ipt_middleJTAId"); 
	     fWindowText1.value = moid; 
	     window.opener.findMiddleWareJTAInfo();
	     window.close();
	} 
}  