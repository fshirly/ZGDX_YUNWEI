		...
		var ajax_param = {
			...
			success : function(data) {
				...
				if (flag=="-1") {
					...
					$("#viewCfgID").val(flag);
					window.frames['component_2'].reloadAllTable(flag);
				}	
			}
		};
...
function doInitTableSound() {
	...
	var viewCfgID = $("#viewCfgID").val();
	if(viewCfgID !="" && viewCfgID !=null){
		uri = path + "/monitor/alarmView/listSound?viewCfgID="+viewCfgID;
	}
	$('#soundtblDataList')
			.datagrid(
					{
...
function doInitTableFilter() {
	...
	var viewCfgID = $("#viewCfgID").val();
	if(viewCfgID !="" && viewCfgID !=null){
		uri = path + "/monitor/alarmView/listFilter?viewCfgID="+viewCfgID;
	}
	$('#filtertblDataList')
			.datagrid(
					{
