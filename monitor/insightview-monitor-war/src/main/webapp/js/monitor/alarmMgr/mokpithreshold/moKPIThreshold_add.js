...
function choseMObject(){
    ...
    if (kpiName == "") {
        ...
        if (showId < 10) {
            $("#isShow").hide();
        } else if (showId == 22 || showId == 26 || showId == 28 || showId == 14 || showId == 15 || showId == 16 || showId == 54 || showId == 55 || showId == 81 || showId == 82 || showId == 86 || showId == 87 || showId == 17 || showId == 18 || showId == 19 || showId == 20 || showId == 53 || showId == 44 || showId == 45 || showId == 59 || showId == 60 || showId == 90 || showId == 91 || showId == 92 || showId == 93 || showId == 96|| showId == 73|| showId == 99) {
            $("#isShow").hide();
        } else {
            $("#isShow").show();
        }
...
function isShowClearBtn(){
    ...
    var sourceName = $("#ipt_sourceName").val();
...
function loadSource(){
	...
	if (null != classID && "" != classID) {
        ...
        if (classID == 5 || classID == 59 || classID == 60 || classID == 7 || classID == 8 || classID == 9) {
            ...
            window.open(uri, "", "height=480px,width=780px,left=400,top=200,resizable=no,scrollings=no,status=no,toolbar=no,menubar=no,location=no");
        } else if (classID == 17 || classID == 18 || classID == 19 || classID == 20 || classID == 53) {
...
function findDeviceInfo(index){
    ...
    var ajax_param = {
        ...
        success: function(data){
            if (index == 0) {
                $("#ipt_sourceName").val(data.moname);
            } else {
                $("#ipt_moName").val(data.moname);
            }
            isShowClearBtn();
...
function findOracleInsInfo(){
    ...
    var ajax_param = {
        ...
        success: function(data){
            $("#ipt_sourceName").val(data.instancename);
            isShowClearBtn();
        }
    };
    ajax_(ajax_param);
...
function findZoneManagerInfo(){
    ...
    var ajax_param = {
        ...
        success: function(data){
            $("#ipt_sourceName").val(data.ipAddress);
            isShowClearBtn();
        }
    };
    ajax_(ajax_param);
...
function findMOReadInfo(){
    ...
    var ajax_param = {
        ...
        success: function(data){
            $("#ipt_sourceName").val(data.readerLabel);
            isShowClearBtn();
        }
    };
    ajax_(ajax_param);
...
function findDB2DbInfo(){
    ...
    var ajax_param = {
        ...
        success: function(data){
            $("#ipt_sourceName").val(data.databaseName);
            isShowClearBtn();
        }
    };
    ajax_(ajax_param);
...
function findMsSqlServerInfo(){
    ...
    var ajax_param = {
        ...
        success: function(data){
            $("#ipt_sourceName").val(data.serverName);
            isShowClearBtn();
        }
    };
    ajax_(ajax_param);
...
function findSybaseServerDetail(){
    ...
    //	console.log("sourceMOID=="+sourceMOID);
    $("#ipt_sourceMOID").val(sourceMOID);
    var path = getRootName();
...
function findSiteDnsInfo(){
    ...
    var ajax_param = {
        ...
        success: function(data){
            $("#ipt_sourceName").val(data.siteName);
            isShowClearBtn();
        }
    };
    ajax_(ajax_param);
