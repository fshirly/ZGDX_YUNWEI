$(document).ready(function(){
    ...
    doHostCPUInitTables(liInfo);// 安全设备-光闸CPU
    doHostMemoryInitTables(liInfo);// 安全设备-光闸内存
    doHostDiskInitTables(liInfo);// 安全设备-光闸硬盘
...
function doHostCPUInitTables(liInfo){
    ...
    $('#tblCPU').datagrid({
        ...
        fit: true,// 自动大小
        fitColumns: true,
        url: path + '/monitor/safeDeviceManager/findCPUDetailInfo?moClass=Shutter',
...
function doHostMemoryInitTables(liInfo){
    ...
    $('#tblMemory').datagrid({
        ...
        fit: true,// 自动大小
        fitColumns: true,
        url: path + '/monitor/safeDeviceManager/findMemoryDetailInfo?moClass=Shutter',
...
function doHostDiskInitTables(liInfo){
    ...
    $('#tblDisk').datagrid({
        ...
        fit: true,// 自动大小
        fitColumns: true,
        url: path + '/monitor/safeDeviceManager/findDiskDetailInfo?moClass=Shutter',
        idField: 'fldId',
...
function doFlowsInitTables(liInfo){
    ...
    $('#tblFlows').datagrid({
        ...
        fit: true,// 自动大小
        fitColumns: true,
        url: path + '/monitor/safeDeviceManager/findFlowsDetailInfo?moClass=Shutter',// findVMDetailFlowsInfo
        idField: 'fldId',
        columns: [[{
            field: 'ifname',
            title: '接口名称',
