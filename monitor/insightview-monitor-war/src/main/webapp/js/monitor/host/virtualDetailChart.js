...
function getCpuChartJsonData(){
	...
	var uri = path + "/monitor/historyManage/virtualCpuChartData";
	var ajax_param = {
		url : uri,
		type : "post",
		datdType : "json",
...
function getHardChartJsonData(){
	var path = getRootPatch();
	var uri = path + "/monitor/historyManage/virtualHardDiskChartData";
	var ajax_param = {
		url : uri,
		type : "post",
		datdType : "json",
...
function getInterfaceChartJsonData(){
	var path = getRootPatch();
	var uri = path + "/monitor/historyManage/virtualInterfaceChartData";
	var ajax_param = {
		url : uri,
		type : "post",
		datdType : "json",
...
function getMemoryChartJsonData(){
	var path = getRootPatch();
	var uri = path + "/monitor/historyManage/virtualMemoryChartData";
	var ajax_param = {
		url : uri,
		type : "post",
		datdType : "json",
...
function getStorageChartJsonData(){
	var path = getRootPatch();
	var uri = path + "/monitor/historyManage/virtualStoreChartData";
	var ajax_param = {
		url : uri,
		type : "post",
		datdType : "json",
...
function toCpuDeatil(){
	...
	var proUrl = "/monitor/historyManage/virtualCpuChartData";
	var moid = $("#MOID").val();
...
function toMemoryDeatil(){
	...
	var proUrl = "/monitor/historyManage/virtualMemoryChartData";
	var url = getRootPatch()+"/monitor/interfaceChart/toHistoryChartsDetail?proUrl="+proUrl+"&perfKind="+perfKind+"&MOID="+moid;;
	window.open(url,"_blank");
}
function toStorageDeatil(){
	...
	var moid = $("#MOID").val();
	var proUrl = "/monitor/historyManage/virtualStoreChartData";
	var url = getRootPatch()+"/monitor/interfaceChart/toHistoryChartsDetail?proUrl="+proUrl+"&perfKind="+perfKind+"&MOID="+moid;
	window.open(url,"_blank");
}
function toHardDiskDeatil(){
	...
	var moid = $("#MOID").val();
	var proUrl = "/monitor/historyManage/virtualHardDiskChartData";
	var url = getRootPatch()+"/monitor/interfaceChart/toHistoryChartsDetail?proUrl="+proUrl+"&perfKind="+perfKind+"&MOID="+moid;
	window.open(url,"_blank");
}
function toInterfaceDeatil(){
	...
	var moid = $("#MOID").val();
	var proUrl = "/monitor/historyManage/virtualInterfaceChartData";
	var url = getRootPatch()+"/monitor/interfaceChart/toHistoryChartsDetail?proUrl="+proUrl+"&perfKind="+perfKind+"&MOID="+moid;
	window.open(url,"_blank");
}
