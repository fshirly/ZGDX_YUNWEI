...
function getHardChartJsonData(){
	var path = getRootPatch();
	var uri = path + "/monitor/historyManage/initHardDiskChartData";
	var ajax_param = {
		url : uri,
		type : "post",
		datdType : "json",
...
function getInterfaceChartJsonData(){
	var path = getRootPatch();
	var uri = path + "/monitor/historyManage/initInterfaceChartData";
	var ajax_param = {
		url : uri,
		type : "post",
		datdType : "json",
...
function toCpuDeatil(){
	var proUrl = "/monitor/historyManage/initCpuChartData";
	var moid = $("#MOID").val();
	var url = getRootPatch()+"/monitor/interfaceChart/toHistoryChartsDetail?proUrl="+proUrl+"&MOID="+moid;
	window.open(url,"_blank");
}
function toMemoryDeatil(){
	var perfKind = $("#memory").val();
	var moid = $("#MOID").val();
	var proUrl = "/monitor/historyManage/initMemoryChartData";
...
function toHardDiskDeatil(){
	...
	var moid = $("#MOID").val();
	var proUrl = "/monitor/historyManage/initHardDiskChartData";
	var url = getRootPatch()+"/monitor/interfaceChart/toHistoryChartsDetail?proUrl="+proUrl+"&perfKind="+perfKind+"&MOID="+moid;
	window.open(url,"_blank");
}
function toInterfaceDeatil(){
	...
	var moid = $("#MOID").val();
	var proUrl = "/monitor/historyManage/initInterfaceChartData";
	var url = getRootPatch()+"/monitor/interfaceChart/toHistoryChartsDetail?proUrl="+proUrl+"&perfKind="+perfKind+"&MOID="+moid;
	window.open(url,"_blank");
}
