$(document).ready(function(){
    ...
    doHostCPUInitTables(liInfo);// 主机CPU
...
function doHostCPUInitTables(liInfo){
    ...
    $('#tblCPU').datagrid({
        ...
        fit: true,// 自动大小
        fitColumns: true,
        url: path + '/monitor/hostManage/findCPUDetailInfo?moClass=host',
...
function doHostMemoryInitTables(liInfo){
    ...
    $('#tblMemory').datagrid({
        ...
        fit: true,// 自动大小
        fitColumns: true,
        url: path + '/monitor/hostManage/findMemoryDetailInfo?moClass=host',
...
function doHostDiskInitTables(liInfo){
    ...
    $('#tblDisk').datagrid({
        ...
        fit: true,// 自动大小
        fitColumns: true,
        url: path + '/monitor/hostManage/findDiskDetailInfo?moClass=host',
        idField: 'fldId',
...
function doFlowsInitTables(liInfo){
    ...
    $('#tblFlows').datagrid({
        ...
        fit: true,// 自动大小
        fitColumns: true,
        url: path + '/monitor/hostManage/findFlowsDetailInfo?moClass=host',// findVMDetailFlowsInfo
        idField: 'fldId',
        columns: [[{
            field: 'ifname',
            title: '接口名称',
