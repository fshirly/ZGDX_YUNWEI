...
#tblFilter input {
    text-align: center;
		...
		<script type="text/javascript"
		src="${pageContext.request.contextPath}/js/monitor/deviceWBListSetting/WBListView_show.js"></script>
		<div class="easyui-tabs" data-options="tabPosition:'left',fit:false,plain:false" id="showWBSetting" style="overflow: auto;height:400px;"> 
			...
			<div id="divAlarmDefine" title="黑白名单定义" data-options="closable:false" style="overflow: auto">
				<table id="tblAlarmAdd" class="tableinfo" style="width: 600px;" >
					...
					<tr>
						<td>
							<b class="title">类型：</b>
							<label id="portType"></label>
						</td>					
					</tr>
					<tr>
						<td>
							<b class="title">是否启用：</b>
							<label id="statusForDevice"></label>
						</td>					
					</tr>
					<tr id="collectorForDeviceTr">
						<td>
							<b class="title">采集机：</b>
							<label id="collectorForDevice"></label>
						</td>					
					</tr>
					</tbody>
				</table>
