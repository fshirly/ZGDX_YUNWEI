...
<html>
  ...
  <body>
	        <script type="text/javascript" src="${pageContext.request.contextPath}/js/monitor/alarmMgr/alarmview/alarmView_add.js"></script>
			<!--告警视图定义新增  -->	
			<input id="viewCfgID" type="hidden" value="" />				
	<div id="resCiAllInfoDiv" class="easyui-tabs"  data-options="tabPosition:'left',fit:false,plain:false" style='height:400px;overflow:auto;'>
		<!-- 视图定义 -->
		<div title="视图定义 " data-options="iconCls:'icon-info',closable:false" 	style="overflow: hidden;">
					...
					<td >
						 <input type="radio" name="userDefault" value="1"/>是
					...
					<td >
						 <input type="text" id="defaultRows" name="defaultRows" />
					</td>
					</tr>
					<tr>
					<td class="title">加载时间（小时 ）：</td>
					<td >
						 <input type="text" id="defaultInterval" name="defaultInterval" />
					</td>
					</tr>
					<tr>
		...
		<!-- 显示列 -->
		<div title="显示列" data-options="iconCls:'icon-set',closable:false" style="overflow: auto;">
				<!-- begin .datas -->
				<div class="datas">
