...
<html>
	...
	<body>
		<div class="lossdata">
			...
			<c:if test="${numPer>0 and numPer<1}">
				<img alt="0" src="${pageContext.request.contextPath}/style/images/webclient/dot.gif" />
			</c:if>
			...
			<img alt="0" src="${pageContext.request.contextPath}/style/images/webclient/ms.gif" />
		</div>
	</body>
</html>
