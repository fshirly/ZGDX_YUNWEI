					...
					<div class="easyui-panel" >
						<table id="tblServDetail" class="tableinfo2">
							...
							<!--<tr>
								...
								<td>
									<b class="title">最大会话数： </b>
									<label id="lbl_connLower" class="input">${mo.connLower}</label>
								</td>
							</tr>-->
							<tr>
								<td>
