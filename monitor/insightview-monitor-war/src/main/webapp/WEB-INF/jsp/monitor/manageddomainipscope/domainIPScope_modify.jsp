...
<html>
	...
	<body>
		<script type="text/javascript"
		src="${pageContext.request.contextPath}/js/monitor/manageddomainipscope/domainIPScope_modify.js"></script>
		<%
			String scopeID =(String)request.getAttribute("scopeID");
		 %>
		<div id="divDomainIPScopeModify">
		<input type="hidden" id="scopeID" value="<%= scopeID%>"/>
			<table id="tblDomainIPScopeModify" class="formtable1">
				<tr>
