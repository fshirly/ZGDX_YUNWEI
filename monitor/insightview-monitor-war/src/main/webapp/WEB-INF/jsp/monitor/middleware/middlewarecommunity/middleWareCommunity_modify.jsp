...
<html>
	...
	<body>
	<div align="left"><script type="text/javascript" src="${pageContext.request.contextPath}/js/monitor/middleware/middlewarecommunity/middlewarecommunity_modify.js"></script> 
		<% 
		 String id =(String)request.getAttribute("id"); 
		%> 
			<input type="hidden" id="ipt_middleWareId" /> 
			<input type="hidden" id="ipt_defaultURL" /> 
			<input type="hidden" id="id" value="<%= id%>" /> 
				</div><table id="tblMiddlewareModify" class="formtable">
					<tr>
						<td class="title">设备IP：</td>
						<td>
							<input id="ipt_deviceIp"  class="input" validator="{'default':'*','length':'1-64'}" readonly="readonly"/><b>*</b> <input id="ipt_deviceId" type="hidden" value=""/>
						...
						<td>
							<input id="ipt_port" type="text" readonly="readonly" validator="{'default':'*' ,'length':'1-128'}" /><b>*</b>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input id="ipt_middleWareType" type="text" readonly="readonly" validator="{'default':'*','length':'1-128'}" />
						</td>
					</tr>
					...
					--><tr>
						...
						<td colspan="3">
							<input id="ipt_url"  type="text" class="x2"
								validator="{'default':'*','length':'1-150'}" onfocus="ipChange();"/>
								<b>*</b>
						</td>
					</tr>
				</table>
