...
<html>
    ...
    <body>
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/js/monitor/syslog/syslogTask_add.js">
        </script>
        <input type="hidden" id="moIds"><input type="hidden" id="deviceips">
        <div id="divAddSyslog" style="height:380px;overflow:auto">
