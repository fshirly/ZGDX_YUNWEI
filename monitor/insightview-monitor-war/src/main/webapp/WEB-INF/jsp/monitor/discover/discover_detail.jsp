...
<html>
	...
	<body>
		<script type="text/javascript"
		src="${pageContext.request.contextPath}/js/monitor/discover/discover_detail.js"></script>
		<%
	...
	<div id="divTaskDetail">
		...
		<table id="tblTaskDetail" class="tableinfo">
			...
			<tr>
				<td>
					<b class="title">发现类型：</b>
					<label id="lbl_tasktypeInfo" ></label>
				</td>
				<td>
					<b class="title">任务状态：</b>
					<label id="lbl_statusInfo" ></label>
				</td>
			</tr>
			<tr>
				<td>
					<b class="title">IP地址1：</b>
					<label id="lbl_ipaddress1" ></label>
				</td>
				<td>
					<b class="title">IP地址2：</b>
					<label id="lbl_ipaddress2" ></label>
				</td>
			</tr>
			<tr>
				<td>
