...
<html>
    ...
    <body>
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/js/monitor/syslog/syslogRule_add.js">
        </script>
        <input type="hidden" id="moIds"><input type="hidden" id="deviceips">
        <div style="height:380px;overflow:auto">
            <div id="divAddSyslog">
                <table id="tblSyslog" class="formtable">
                    <tr>
                        <td class="title">
                            规则名称：
                        </td>
                        <td>
                            <input id="ipt_ruleName" validator="{'default':'*','length':'1-128'}" /><b>*</b>
                        </td>
                        <td class="title">
                            适用范围：
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <input class="normalInput x2" id="ipt_keyword" validator="{'length':'0-60'}" style="width:499px" value="多个关键字用','分隔" onFocus="if (this.value==this.defaultValue){this.className = 'x2'; this.value='';}" onblur="if (this.value==''){this.className = 'normalInput x2'; this.value=this.defaultValue;}">
                            </input>
                        </td>
                    </tr>
                    <tr>
			...
			<br/>
            <div class="datas">
                <table id="tblAddCollector">
                </table>
            </div>
            <div class="conditionsBtn">
                <input type="button" value="确定" onclick="javascript:toAdd();"/><input type="button" value="取消" onclick="javascript:$('#popWin').window('close');"/>
            </div>
        </div>
    </body>
</html>