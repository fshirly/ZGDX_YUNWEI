...
<html>
	...
	<body> 
		<script type="text/javascript"	src="${pageContext.request.contextPath}/js/monitor/discover/discover_list.js"></script>
		...
		<div class="conditions" id="divFilter">
			<table>
				<tr>
					...
					<td>
						<b>发现类型：</b>
						<select class="easyui-combobox" id="txtTaskType">
