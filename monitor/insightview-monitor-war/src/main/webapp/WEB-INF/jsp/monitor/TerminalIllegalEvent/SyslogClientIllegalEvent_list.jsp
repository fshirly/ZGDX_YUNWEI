...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/monitor/TerminalIllegalEvent/SyslogClientIllegalEvent_list.js"></script>
		...
		<div class="conditions" id="divFilter">
				<table>
					<tr>
						...
						<td><b>终端编号：</b><input id="clientNo" name="clientNo"/></td>
						
					</tr>
					<tr>
						<td><b>类别：</b><input id="typeId" name="typeId"></td>
						<td><b>发生时间：</b><input class="easyui-datebox" id="firstTime" name="firstTime"/> 
						    - <input class="easyui-datebox" id="lastTime" name="lastTime"/></td>
					    <td class="btntd">
