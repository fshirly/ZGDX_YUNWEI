...
<html>
	...
	<div id="serviceLevelTabs"   class="easyui-tabs" style="height: 270px;">
			...
			<!-- <div title="会话" style="overflow-x: hidden;">
				<select id="chat" name="chat" onchange="getChatChartJsonData()">
					<option value="1">当前会话数</option>
				    <option value="2">当前新建会话数</option>
				</select>
				<div id="chat_line" style="height:210px;" ondblclick="toChatDeatil()"></div>
			</div> -->	
		</div>
	</body>
</html>