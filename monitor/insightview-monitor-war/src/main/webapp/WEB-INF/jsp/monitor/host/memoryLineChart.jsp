...
<html>
	...
	<body><input type="hidden" id="MOID" name="MOID" value="${MOID}"/>
				...
				<div id="memory_line" style="height:400px; border:1px solid #ccc;"></div>
			
	</body>
	<!-- 注意需要放到文件末尾处 -->
<script src="${pageContext.request.contextPath}/js/monitor/echarts/echarts-plain-map.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/monitor/host/memoryLineChart.js"></script>
