...
<html>
	...
	<style>
      ...
      width:180px;
		...
		src="${pageContext.request.contextPath}/js/monitor/perf/offlinePerfTask_detail.js"></script>
		<%
	...
	<div style="overflow:auto;height: 350px;">
		...
		<table id="tblViewTask" class="tableinfo">
			...
			<tr>
				<td>
					<div style='float:left;'><b class="title">离线采集机：</b></div>
					<div class="label2"><label id="lbl_collectorName" class="input"></label></div>
				</td>
				<td></td>
			</tr>
		</table>
