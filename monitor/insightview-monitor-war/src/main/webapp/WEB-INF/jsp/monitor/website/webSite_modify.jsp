...
<html>
	...
	<body>
		<script type="text/javascript"
		src="${pageContext.request.contextPath}/js/monitor/website/webSite_modify.js"></script>
		...
		<div id="divWebSiteModify" style="height: 450px;overflow: auto;">
	      ...
	      <input type="hidden" id="siteCommunityId" />
			<table class="formtable" >
				<tr style="float:left;margin-left: 4px;">
					...
					<td colspan="3">
						<input id="ipt_moClassID" type="hidden"/>
			...
			<table id="tblSiteDNS" class="formtable" style="display: none;">
				...
				--%><tr>
					...
					<td colspan="3">
						<input id="ipt_dnsIPAddr" type="text" class="x2" validator="{'length':'0-128'}" />
					</td>
				</tr>
				<tr>
			...
			<div class="conditionsBtn">
				<input type="button" id="btnSave" value="确定" onclick="javascript:toUpdateSite();"/>
