...
<html>
			...
			<div title="通知策略定义" data-options="closable:false" >
					<table id="tblAlarmNotifyCfgAdd" class="formtable"  style="width: 660px;">
						<tr>
							...
							<td><input id="ipt_policyName" validator="{'default':'*','length':'1-30'}"></input><b>*</b></td>
							<td class="title">重复告警条件（次）：</td>
							<td><input id="ipt_alarmOnCount" class="input" validator="{'default':'checkEmpty_noInteger'}"/><b>*</b>
							</td>
						</tr>
						<tr>
	...
	<script type="text/javascript"
			src="${pageContext.request.contextPath}/js/monitor/alarmMgr/alarmnotifycfg/alarmNotifyCfg_modify.js"></script>
	</body>
</html>
