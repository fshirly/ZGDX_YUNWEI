...
@Service("common_96")
public class DeleteAcdition extends DeleteObjectServiceImpl {
...
//		taskMap.put("PerfRoomConditions", MOID);
	...
	public void deletePerfAndAlarm(Map<String, Object> map) {
		...
		// 删除性能表
		Map<String, Object> taskMap = new HashMap<String, Object>();
		taskMap.put("tableName", "PerfRoomConditions");
		taskMap.put("MOID", MOID);
		deviceMapper.deleteTaskAndIP(taskMap);
