 ...
 * 删除物理主机对象数据
 */
public class DeleteHost extends DeleteObjectServiceImpl{
...
//		 Map<String, Object> temp = new HashMap<String, Object>();
		...
		hosPrefMap.put("PerfServCPU", "MOCPUs");
		hosPrefMap.put("PerfServDisk", "MOVolumes");
		hosPrefMap.put("PerfServMemory", "MOMemories");
		hosPrefMap.put("PerfNetworkIf", "MONetworkIf");
		...
		// 删除该设备的子对象及其他性能数据
			...
			PrefMap.put("ProcessInfo", MOID);
			PrefMap.put("PerfSnapshotHost", MOID);
