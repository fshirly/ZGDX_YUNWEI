...
@Service("common_safeService")
/**
 * 删除网络设备数据
 */
public class DeleteSafeSecurity extends DeleteObjectServiceImpl {
	...
	public boolean delete(Map<String, Object> map) {
		...
		/*
		 * // 删除性能数据 Map<String, Object> netWorkPrefMap = new HashMap<String,
		 * Object>(); netWorkPrefMap.put("PerfNetworkCPU", "MOCPUs");
		 * netWorkPrefMap.put("PerfNetworkMemory", "MOMemories");
		 * netWorkPrefMap.put("PerfNetworkIf", "MONetworkIf"); for(String
		 * hostKey:netWorkPrefMap.keySet()){ parm = new HashMap<String,
		 * Object>(); parm.put("prefTableName", hostKey); for(String key :
		 * temp.keySet()){ if(key.equals(netWorkPrefMap.get(hostKey))){
		...
		PrefMap.put("PerfSnapshotNetDevice", MOID);
		...
		if (deviceMapper.deleteMOVolumes(map) >= 0) {
	...
	public void deletePerfAndAlarm(Map<String, Object> map) {
		...
		// 删除性能数据
		Map<String, Object> netWorkPrefMap = new HashMap<String, Object>();
		netWorkPrefMap.put("PerfNetworkCPU", "MOCPUs");
		netWorkPrefMap.put("PerfNetworkMemory", "MOMemories");
		netWorkPrefMap.put("PerfNetworkIf", "MONetworkIf");
		for (String hostKey : netWorkPrefMap.keySet()) {
			parm = new HashMap<String, Object>();
			parm.put("prefTableName", hostKey);
			for (String key : temp.keySet()) {
				if (key.equals(netWorkPrefMap.get(hostKey))) {
