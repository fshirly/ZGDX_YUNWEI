package com.fable.insightview.platform.rescatedef.dao;
...
/**
 * @ClassName:     IResCateDefDao.java
 * @Description:   产品目录Dao 
 * @author         郑小辉
 * @Date           2014-6-30 上午10:24:24 
 */
public interface IResCateDefDao extends GenericDao<ResCateDefInfo>{
	/**
	 * ID查询
	 * @param id
	 * @return
