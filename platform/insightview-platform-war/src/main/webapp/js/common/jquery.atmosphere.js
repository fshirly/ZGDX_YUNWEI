...
// CORS fake using JSONP
                ...
                if ((rq.transport == 'streaming') && (document.all)) {
...
// Remote server disconnected us, reconnect.
                        ...
                        } else if (!document.all && ajaxRequest.readyState == 3 && ajaxRequest.status == 200 && rq.transport != 'long-polling') {
                            update = true;
                        } else {
                            clearTimeout(rq.id);
                        }
...
// Suppose you can subscribe once to an url
        ...
        checkCORSSupport : function() {
            if (document.all && !window.XDomainRequest) {
                return true;
