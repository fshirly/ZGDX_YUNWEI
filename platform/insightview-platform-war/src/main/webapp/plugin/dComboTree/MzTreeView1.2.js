...
function MzTreeView(Tname,haveCheckBox)
{
  ...
  this.icons    = {
    ...
    checked    : 'check.gif', //选中
    checkNot      : 'checkNot.gif',   //非选中
    checkGray    : 'checkGray.gif', //灰色复选框
    exit      : 'exit.gif'
  };
...
MzTreeView.prototype.focus = function(sourceId, defer)
{
  ...
  {
    top.window.status = "节点 "+ sourceId +" 没有正确的挂靠有效树节点上！   "+
...
//设置节点的选中状态
//sourceId 数据源中的父子节点组合的字符串 0_1中的1
...
//取得该节点的所有子节点ID的数组，数组中包含的是父子节点组合的字符串(0_1)中的后一个ID
//id 树的客户端节点 id
...
//取得该节点的所有子节点的数组，数组中只有数据源中的父子节点组合的字符串 0_1，而不是节点对象
//id 树的客户端节点 id
...
//取得该节点的所有子节点的数组，数组中只有数据源中的父子节点组合的字符串 0_1，而不是节点对象
//sourceIndex 数据源中的父子节点组合的字符串 0_1
//mode 模式，为1时取得所有子节点，包括孙子节点，重孙子节点，其它时只取一层子节点
...
//取得该节点的数据源中的父子节点组合的字符串(sourceIndex) 0_1
//itemId 数据源中的父子节点组合的字符串中和ID （0_1 中的1）
...
//取得所有它下一级子节点的ID（一层）
//itemId 数据源中的父子节点组合的字符串中的ID （0_1 中的1）
//返回 它下一级的所有子节点
