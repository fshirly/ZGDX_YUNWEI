	...
	<div id="divPopPage">
		<table id="tblAddInputAttr" class="formtable1" >
			...
			<tr>
				...
				<td ><input id="initSQL" name="initSQL" class="easyui-combobox element" elementType="combobox" value="${attribute.initSQL}" style="width:182px" editable="false"></td>
			</tr>
			<tr>
			  <td class="title">是否显示用户名：</td>
			  <td><input id="isShowUserName" name="isShowUserName" value="${attribute.isShowUserName}" class="easyui-combobox element" elementType="combobox" style="width:182px" editable="false"></td>
			</tr>
		</table>
	</div>
	<script>
