...
<body>
	<div id="divPopPage">
		<table id="tblAddInputAttr" class="formtable1" >
			...
			<tr>
			  <td class="title">是否显示时间：</td>
			  <td><input id="showTime" name="showTime" value="${attribute.showTime}" class="easyui-combobox element" elementType="combobox" style="width:182px" editable="false"></td>
			</tr>
			<tr>
