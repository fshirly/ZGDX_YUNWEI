...
<html>
  ...
  <body>
	<script type="text/javascript"	src="${pageContext.request.contextPath}/js/platform/ipmanager/deptInfo_list.js"></script>
	...
	<input type="hidden" id="subNetId" value="<%= subNetId%>"/>
	  	<div class="conditions" id="divFilter">
	  	 <form id="frmExport"
				action="${pageContext.request.contextPath}/platform/subnetViewManager/exportDeptVal">
		  ...
		  <input name="belongDeptId" id="belongDeptId" type="hidden"/> 
		  <input name="exlName" id="iptExlName" value="子网部门信息列表.xls" type="hidden" />
	  	  <table>
	  	  	<tr>
	  	  	  <td>
	  	  	      <b>筛选地址范围：</b>
	  	...
	  	<div class="datas tops1">
			<table id="tblAllDeptList">
			</table>
		</div>
	</div>
	
	<div id="divExportAllDept" class="easyui-window" minimizable="false"
					...
					<td style='vertical-align: bottom;'>
						<select id="selLeft"
							...
							class="dataSelect" onclick="doLoseTargetFocus()">
								...
								<option alt="statusName">状态</option>
