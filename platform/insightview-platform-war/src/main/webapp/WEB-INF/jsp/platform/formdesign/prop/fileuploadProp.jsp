...
<body>
	<div id="divPopPage">
		<table id="tblAddFileUploadAttr" class="formtable1" >
			<tr>
				<td class="title">属性名称：</td>
				<td ><input id="attributesLabel" validator="{'default':'*'}" class="element" elementType="normal" name="attributesLabel" value="${attribute.attributesLabel}" /><b>*</b></td>
			</tr>
			<tr>
