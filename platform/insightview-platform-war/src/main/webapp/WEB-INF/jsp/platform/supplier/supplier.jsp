...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/platform/supplier/supplier_add.js"></script>
	<div id="supplierAdd" class="easyui-tabs">   
	    <div title="基础信息" data-options="closable:false">
	    	<input type="hidden" id="localData" value="1"/>
	        ...
	        <table id="tblAddProvider" class="formtable">
					<tr>
						...
						<td>
							<input type="text" id="ipt_providerName" name="ipt_providerName"  validator="{'length':'1-30'}" msg="{reg:'只能输入1-30位字符！'}"/><b>*</b>
						</td>
						<td class="title">
							联系人：
						</td>
						<td>
							<input type="text" id="ipt_contacts" name="ipt_contacts" validator="{'length':'2-15'}" msg="{reg:'只能输入2-15位字符！'}" /><b>*</b>
						</td>
					</tr>
					<tr>
						<td class="title">
						...
						<td>
							<input type="text" id="ipt_contactsTelCode" name="ipt_contactsTelCode" validator="{'default':'phoneAndTelNum'}" msg="{reg:'只能输入数字！'}"/>
						</td>
						<td class="title">
							传真：
						</td>
						<td>
							<input id="ipt_fax" name="ipt_fax" validator="{'default':'checkEmpty_fax'}"/><b>*</b>
						</td>
					</tr>
					<tr>
						<td class="title">
						...
						<td>
							<input id="ipt_techSupportTel" name="ipt_techSupportTel" validator="{'default':'phoneAndTelNum'}" msg="{reg:'只能输入数字！'}"/>
						</td>
						<td class="title">
							E-mail：
						</td>
					...
					<tr>
						...
						<td>
							<input id="ipt_build" name="ipt_build" validator="{'default':'*','type':'datebox'}"/><b>*</b>
						</td>
						<td class=title>
							员工数：
						</td>
						<td >
							<select id="ipt_employee" name="ipt_employee" class="easyui-combobox" data-options="editable:false">
					...
					<tr>
						...
						<td colspan="3">
							<input type="text" id="ipt_fund" name="ipt_fund" validator="{'default':'num','length':'1-16'}"/><b>*</b>
						</td>
					</tr>
					<tr>
						<td class=title>
						...
						<td colspan="3">
							<input type="text" id="ipt_address" name="ipt_address" class="x2" validator="{'default':'*','length':'0-200'}"/>
						</td>
					</tr>
					<tr>
						<td class="title">
					...
					<tr>
						...
						<td colspan="3">
							<textarea id="ipt_descr" name="ipt_dnescr" class="x2" rows="3" validator="{'default':'*','length':'0-500'}"></textarea>
						</td>
					</tr>
					<tr>
