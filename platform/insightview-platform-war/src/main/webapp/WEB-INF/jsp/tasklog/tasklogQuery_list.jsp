...
<body>
	<div class="conditions">
		<table>
			<tr>
				...
				<td class="btntd">
					<a href="javascript:tasklog.query.search();">查询</a>
					<a href="javascript:tasklog.query.reset();">重置</a>
				</td>
			</tr>
		</table>
	</div>
	...
	<div class="datas" style="top: 48px;">
		<table id="tblTaskLogQueryList"></table>
	</div>
	
	<div id="tasklogQuery_popWin"></div>
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/tasklog/tasklogQuery_list.js"></script>
</body>
</html>